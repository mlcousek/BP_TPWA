    ...
    public class CvikController : Controller
    {
        ...
        public async Task<IActionResult> PridejData()
        {
            ...
            if (userId != null)
            {
                ...
                var cvik1 = new Cvik { Název = "Dřepy s vlastní vahou", PočetSérií = 3, PočetOpakování = "10, 10, 10", PauzaMeziSériemi = 30, PopisCviku = "Zahřátí + aktivace", Partie = "Nohy", UzivatelId = userId };
                if (cvik1.TypyTreninku == null)
                {
                    cvik1.TypyTreninku = new List<string>();
                }
                cvik1.TypyTreninku.Add("BSHVMNohy");
                var cvik2 = new Cvik { Název = "Zadní dřepy", PočetSérií = 5, PočetOpakování = "x", PauzaMeziSériemi = 0, PopisCviku = "Silový cvik dřep", Partie = "Nohy", UzivatelId = userId };
                if (cvik2.TypyTreninku == null)
                {
                    cvik2.TypyTreninku = new List<string>();
                }
                cvik2.TypyTreninku.Add("BSHVMNohy");
                var cvik3 = new Cvik { Název = "Legpress", PočetSérií = 4, PočetOpakování = "10, 10, 12, 12", PauzaMeziSériemi = 60, PopisCviku = "Popis legpress", Partie = "Nohy", UzivatelId = userId };
...
;
                ...
                var cvik11 = new Cvik { Název = "Tlaky na ramena - rozcvička", PočetSérií = 2, PočetOpakování = "10, 10", PauzaMeziSériemi = 20, PopisCviku = "Zahřátí + aktivace (velmi malá nebo žádná váha)", Partie = "Ramena", UzivatelId = userId };
                ...
                var cvik20 = new Cvik { Název = "Kliky", PočetSérií = 3, PočetOpakování = "10, 10, 10", PauzaMeziSériemi = 40, PopisCviku = "Klasické kliky - záhřátí aktivace", Partie = "Hrudník", UzivatelId = userId };
                ...
                var cvik28 = new Cvik { Název = "Mrtvý tah bez závaží", PočetSérií = 3, PočetOpakování = "10, 10, 10", PauzaMeziSériemi = 40, PopisCviku = "Mrtvý tah bez závaží (zatínat svaly) - záhřátí aktivace", Partie = "Záda", UzivatelId = userId };
