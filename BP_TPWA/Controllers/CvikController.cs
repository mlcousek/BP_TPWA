    ...
    public class CvikController : Controller
    {
        ...
        public IActionResult PridejData()
        {
            ...
            if(userId != null)
            {
                ...
                var cvik32 = new Cvik { Název = "Přitahování tyče na stroji - horizontálně", PočetSérií = 4, PočetOpakování = "10, 10, 10, 10", PauzaMeziSériemi = 60, PopisCviku = "Stahování na stoji", Partie = "Záda", TypTreninku = "BSHVMHrZada", UzivatelId = userId };
